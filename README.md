...
* [pinknoise.ipynb](pinknoise.ipynb) is a model implementation of a pink noise generator based on a 3rd order pinking filter. The script calculates the filter coefficients and displays its frequency response. White noise is passed through the filter and the amplitude spectrum of the unfiltered and filtered noise is displayed for verification.
